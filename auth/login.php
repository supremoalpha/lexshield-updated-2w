...
$error = '';
$success = '';
$loginOtpEnabled = filter_var(getenv('LOGIN_OTP_ENABLED') ?: 'true', FILTER_VALIDATE_BOOL);
$adminOtpEnabled = filter_var(getenv('ADMIN_OTP_ENABLED') ?: 'true', FILTER_VALIDATE_BOOL);
